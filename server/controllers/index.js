...
module.exports.displayHomePage = (req, res, next) => {
    res.render('home', { title: 'Home', username:req.user?req.user.username:'' });
}
...
module.exports.displayContactMePage = (req, res, next) => {
    res.render('contactme', { title: 'Contact Me', username:req.user?req.user.username:'' });
}
...
module.exports.processLoginPage = (req, res, next) =>{
    passport.authenticate('local', (err, user, info) => {
        ...
        //Determine if there was a login error
        if(!user)
        {
        ...
        req.login(user, (err) =>{
            //Determine if there is a server error
            if(err)
            {
                return next(err);
            }
